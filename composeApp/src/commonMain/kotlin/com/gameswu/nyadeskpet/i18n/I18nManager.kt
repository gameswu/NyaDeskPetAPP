...
object I18nManager {
    ...
    private val translations: Map<String, Map<String, String>> = mapOf(
        "zh-CN" to mapOf(
            ...
            "settings.enableEyeTracking" to "视线跟随",
            ...
            "agent.mcp.headers" to "请求头（每行 Key: Value）",
            "agent.mcp.autoStart" to "自动连接",
            "agent.mcp.connect" to "连接",
            "agent.mcp.disconnect" to "断开",
            "agent.mcp.delete" to "删除",
            "agent.mcp.toolCount" to "个工具",
        ...
        "en-US" to mapOf(
            ...
            "settings.enableEyeTracking" to "Eye Tracking",
            ...
            "agent.mcp.edit" to "Edit MCP Server",
            ...
            "agent.mcp.headers" to "Headers (Key: Value per line)",
            "agent.mcp.autoStart" to "Auto Connect",
            "agent.mcp.connect" to "Connect",
            "agent.mcp.disconnect" to "Disconnect",
            "agent.mcp.delete" to "Delete",
            "agent.mcp.toolCount" to "tools",
